      ...
      children: [
        ...
        GridView.count(
          ...
          children: [
            ...
            buildIconButton('Phòng trọ\nsinh viên', Icons.house),
            buildIconButton('Phòng trọ\ncó gác', Icons.stairs),
            buildIconButton('Phòng trọ\ngiá rẻ', Icons.attach_money),
            buildIconButton('Nuôi\nthú cưng', Icons.pets),
            buildIconButton('Có\nban công', Icons.balcony),
            buildIconButton('Phòng trọ\ntheo quận', Icons.location_on),
            buildIconButton('Căn hộ\ndịch vụ', Icons.hotel),
            buildIconButton('Cho người\nnước ngoài', Icons.people),
          ],
        )
      ],
    );
    ...
    return Column(
      ...
      children: [
        Container(
          ...
          child: Icon(icon, size:25, color: AppColors.mainColor), // Kích thước icon
        ),
        SizedBox(height: 8),
        Text(
          text,
